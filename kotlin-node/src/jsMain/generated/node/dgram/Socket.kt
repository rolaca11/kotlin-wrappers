...
fun send(msg: ReadonlyArray<Any?>, port: Number = definedExternally, address: String = definedExternally, callback: (error: Throwable /* JsError */?, bytes: Double) -> Unit = definedExternally): Unit
...
fun send(msg: String, offset: Number, length: Number, port: Number = definedExternally, address: String = definedExternally, callback: (error: Throwable /* JsError */?, bytes: Double) -> Unit = definedExternally): Unit

fun send(msg: Uint8Array, offset: Number, length: Number, port: Number = definedExternally, address: String = definedExternally, callback: (error: Throwable /* JsError */?, bytes: Double) -> Unit = definedExternally): Unit
