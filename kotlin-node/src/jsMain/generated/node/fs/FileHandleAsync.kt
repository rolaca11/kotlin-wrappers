...
@JsName("read")
fun <T : js.buffer.ArrayBufferView> readAsync(buffer: T, offset: Double? = definedExternally, length: Double? = definedExternally, position: Double? = definedExternally): Promise<FileReadResult<T>>
...
suspend inline fun <T : js.buffer.ArrayBufferView> read(buffer: T, offset: Double? = definedExternally, length: Double? = definedExternally, position: Double? = definedExternally): FileReadResult<T> =
    readAsync(
...
@JsName("write")
fun <TBuffer : Uint8Array> writeAsync(buffer: TBuffer, offset: Double? = definedExternally, length: Double? = definedExternally, position: Double? = definedExternally): Promise<FileHandleWriteResultPayload<TBuffer>>
...
suspend inline fun <TBuffer : Uint8Array> write(buffer: TBuffer, offset: Double? = definedExternally, length: Double? = definedExternally, position: Double? = definedExternally): FileHandleWriteResultPayload<TBuffer> =
    writeAsync(
        buffer, offset, length, position
    ).await()
