...
/**
     ...
     * @since v0.0.2
     */
external fun <TBuffer : js.buffer.ArrayBufferView> write(fd: Number, buffer: TBuffer, offset: Double?, length: Double?, position: Double?, callback: (err: node.ErrnoException?, written: Double, buffer: TBuffer) -> Unit): Unit
...
/**
     ...
     */
external fun <TBuffer : js.buffer.ArrayBufferView> write(fd: Number, buffer: TBuffer, offset: Double?, length: Double?, callback: (err: node.ErrnoException?, written: Double, buffer: TBuffer) -> Unit): Unit
