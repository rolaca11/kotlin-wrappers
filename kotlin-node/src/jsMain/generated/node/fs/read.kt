...
/**
     ...
     */
external fun <TBuffer : js.buffer.ArrayBufferView> read(fd: Number, buffer: TBuffer, offset: Number, length: Number, position: ReadPosition?, callback: (err: node.ErrnoException?, bytesRead: Double, buffer: TBuffer) -> Unit): Unit
