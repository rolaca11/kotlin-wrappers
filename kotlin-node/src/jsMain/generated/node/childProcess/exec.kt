...
external fun exec(command: String, options: ExecStringOptions, callback: (error: ExecException?, stdout: Any /* string | Buffer */, stderr: Any /* string | Buffer */) -> Unit = definedExternally): ChildProcess
...
external fun exec(command: String, options: (ExecObjectEncodingOptions)?, callback: (error: ExecException?, stdout: Any /* string | Buffer */, stderr: Any /* string | Buffer */) -> Unit = definedExternally): ChildProcess
