...
/**
         ...
         */
val signalCode: node.process.Signals?
/**
         * The `subprocess.spawnargs` property represents the full list of command-line
         * arguments the child process was launched with.
         */
val spawnargs: js.core.ReadonlyArray<String>
/**
...
/**
         ...
         * @since v0.1.90
         */
fun kill(signal: node.process.Signals = definedExternally): Boolean
...
fun send(message: Serializable, sendHandle: SendHandle = definedExternally, options: MessageOptions = definedExternally, callback: (error: Throwable /* JsError */?) -> Unit = definedExternally): Boolean
/**
