...
external fun verify(algorithm: String?, data: js.buffer.ArrayBufferView, key: VerifyKeyObjectInput, signature: js.buffer.ArrayBufferView, callback: (error: Throwable /* JsError */?, result: Boolean) -> Unit): Unit

external fun verify(algorithm: String?, data: js.buffer.ArrayBufferView, key: VerifyPublicKeyInput, signature: js.buffer.ArrayBufferView, callback: (error: Throwable /* JsError */?, result: Boolean) -> Unit): Unit

external fun verify(algorithm: String?, data: js.buffer.ArrayBufferView, key: VerifyJsonWebKeyInput, signature: js.buffer.ArrayBufferView, callback: (error: Throwable /* JsError */?, result: Boolean) -> Unit): Unit
