...
external fun generateKeyPair(type: KeyType.rsa, options: RSAKeyPairDerDerOptions, callback: (err: Throwable /* JsError */?, publicKey: node.buffer.Buffer, privateKey: node.buffer.Buffer) -> Unit): Unit
...
external fun generateKeyPair(type: KeyType.rsaPss, options: RSAPSSKeyPairDerDerOptions, callback: (err: Throwable /* JsError */?, publicKey: node.buffer.Buffer, privateKey: node.buffer.Buffer) -> Unit): Unit
...
external fun generateKeyPair(type: KeyType.dsa, options: DSAKeyPairDerDerOptions, callback: (err: Throwable /* JsError */?, publicKey: node.buffer.Buffer, privateKey: node.buffer.Buffer) -> Unit): Unit
...
external fun generateKeyPair(type: KeyType.ed25519, options: ED25519KeyPairDerDerOptions, callback: (err: Throwable /* JsError */?, publicKey: node.buffer.Buffer, privateKey: node.buffer.Buffer) -> Unit): Unit
...
external fun generateKeyPair(type: KeyType.ed448, options: ED448KeyPairDerDerOptions, callback: (err: Throwable /* JsError */?, publicKey: node.buffer.Buffer, privateKey: node.buffer.Buffer) -> Unit): Unit
...
external fun generateKeyPair(type: KeyType.x25519, options: X25519KeyPairDerDerOptions, callback: (err: Throwable /* JsError */?, publicKey: node.buffer.Buffer, privateKey: node.buffer.Buffer) -> Unit): Unit
...
external fun generateKeyPair(type: KeyType.x448, options: X448KeyPairDerDerOptions, callback: (err: Throwable /* JsError */?, publicKey: node.buffer.Buffer, privateKey: node.buffer.Buffer) -> Unit): Unit
